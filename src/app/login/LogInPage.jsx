          ...
          <div>
            ...
            <div className="flex">
              ...
              <input 
                type="email" 
                id="email" 
                className={`rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 ${errors.email ? 'border-red-500' : ''}`} 
          ...
          <div>
            ...
            <div className="flex">
              ...
              <input 
                type="password" 
                id="password" 
                className={`rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 ${errors.password ? 'border-red-500' : ''}`} 
