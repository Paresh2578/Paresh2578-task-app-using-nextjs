    ...
    <div className="flex justify-center h-[80vh] items-center p-5">
      <div className="container xl:w-1/3 lg:w-1/2 sm:w-1/2  h-fit border p-5 rounded-xl shadow-lg bg-white">
        ...
        <form className="flex flex-col space-y-2">
            ...
            {/* username */}
            <div>
                <label for="website-admin" className="block text-sm  text-black">Username <span className="text-red-600">*</span></label>
                <div className="flex">
            ...
            <div className="flex items-center justify-center mt-4">
                <button type="submit" className="bg-primary hover:bg-[#5e34ba] text-white font-bold py-2 px-4 rounded">Sign up</button>
            </div>
